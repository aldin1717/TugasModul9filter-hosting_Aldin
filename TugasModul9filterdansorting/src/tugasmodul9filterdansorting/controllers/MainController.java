...
public class MainController implements Initializable {
    ...
    private void initComboBoxes() {
        ...
        cbxSorting.setItems(FXCollections.observableArrayList(
            "Judul A-Z", "Judul Z-A", "Pengadaan Terbaru", "Pengadaan Lama"
        ));
    ...
    private void loadTable(String kategori, String sorting) {
        bukuList.setAll(BukuDAO.getFilteredAndSorted(kategori, sorting));
        tblViewBuku.setItems(bukuList);
    }

    @FXML
    private void handleFilterAndSort() {
        String kategori = cbxKategori.getValue();
        String sorting = cbxSorting.getValue();
        loadTable(kategori, sorting);
    }
